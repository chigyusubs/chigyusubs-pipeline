...
def _merge_review(
    ...
    *,
    ...
    objective_yellow_reasons: list[str] = []
    if hard_cps_violations:
        objective_yellow_reasons.append("hard_cps")
    if line_violations:
        objective_yellow_reasons.append("line_count")

    objective = "yellow" if objective_yellow_reasons else "green"
